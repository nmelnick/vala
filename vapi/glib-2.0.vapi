...
namespace GLib {
	...
	[Version (since = "2.50")]
	public void message_structured (string format, ...);
	[Version (since = "2.50")]
	public void warning_structured (string format, ...);
	[Version (since = "2.50")]
	public void critical_structured (string format, ...);
	[NoReturn]
	[Version (since = "2.50")]
	public void error_structured (string format, ...);
	[Version (since = "2.50")]
	public void debug_structured (string format, ...);
	[Version (since = "2.50")]
	public void info_structured (string format, ...);
